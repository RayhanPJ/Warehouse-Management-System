                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/editData/<?= $item['id_item']; ?>" method="post" class="needs-validation" novalidate>
                                <?= csrf_field(); ?>
                                <div class="mb-3">
                                    <div class="row">
                                        <div class="col">
                                ...
                                <div class="mb-3">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" id="name_item" placeholder="Name Item" name="name_item" value="<?= $item['name_item']; ?>" />
                                            <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
