...
(function (h) {
  ...
  function Ia(a) {
    ...
    for (f = b.length; e < f; e++)
      if (((m = b[e]), (r = []), !m.sType && m._sManualType))
  ...
  function P(a, b) {
    ...
    if (-1 !== h.inArray(!1, c)) D(a, !1);
      ...
      j !== k &&
        -1 !== j &&
        ((a._iDisplayStart = i ? j : j >= a.fnRecordsDisplay() ? 0 : j),
      ...
      if (0 !== n.length) {
        ...
        for (i = i ? 0 : j; i < g; i++) {
          ...
          if (0 !== f) {
            var l = e[d % f];
            r._sRowStripe != l &&
              (h(G).removeClass(r._sRowStripe).addClass(l),
              (r._sRowStripe = l));
          }
  ...
  function wb(a) {
    ...
    for (g = 0; g < c; g++)
      (n = b[g]),
        ...
        r("mDataProp_" + g, i),
        d.bFilter &&
          (r("sSearch_" + g, m.sSearch),
          r("bRegex_" + g, m.bRegex),
  ...
  function ma(a) {
    ...
    if (a.scrollBarVis !== M && a.scrollBarVis !== k)
      (a.scrollBarVis = M), aa(a);
    else {
      a.scrollBarVis = M;
      p.children("thead, tfoot").remove();
      t &&
        ((R = t.clone().prependTo(p)), (Q = t.find("tr")), (R = R.find("tr")));
  ...
  function Ha(a) {
    ...
    for (l = 0; l < i.length; l++)
      (o = c[i[l]]),
        null !== o.sWidth && ((o.sWidth = Gb(o.sWidthOrig, k)), (r = !0));
    if (d || (!r && !f && !e && j == W(a) && j == n.length))
      for (l = 0; l < j; l++)
      ...
      if (a.aoData.length)
        for (l = 0; l < i.length; l++)
          (r = i[l]),
            (o = c[r]),
            h(Hb(a, r)).clone(!1).append(o.sContentPadding).appendTo(s);
  ...
  function Lb(a, b, c) {
    var d,
      ...
      b = function (b) {
        if (b && b.time) {
          var g = u(a, "aoStateLoadParams", "stateLoadParams", [a, b]);
          if (
            -1 === h.inArray(!1, g) &&
            ((g = a.iStateDuration),
            ...
            u(a, "aoStateLoaded", "stateLoaded", [a, b]);
          }
        }
        c();
      };
  ...
  var l = function (a) {
      ...
      this.api = function (a) {
        return a ? new s(Aa(this[v.iApiIndex])) : new s(this);
      };
  ...
  h.extend(s.prototype, {
    ...
    iterator: function (a, b, c, d) {
      ...
      if (e.length || d) {
        a = new s(m, a ? e.concat.apply([], e) : e);
        b = a.selector;
        b.rows = o.rows;
        b.cols = o.cols;
        b.opts = o.opts;
    ...
    unique: function () {
      return new s(this.context, ra(this));
    },
    unshift: x.unshift,
  });
  ...
  s.registerPlural = t = function (a, b, c) {
    s.register(a, c);
  ...
  o("tables()", function (a) {
    return a !== k && a !== null ? new s(Vb(a, this.context)) : this;
  });
  o("table()", function (a) {
    var a = this.tables(a),
      b = a.context;
            ...
            if (a === null || a === k || c) {
              ...
              for (s = g.length; t < s; t++) {
                ...
                for (u = 0; u < n; u++) {
                  ...
                  if (c) {
                    v = f[l];
                    a(w, B(b, l, u), v.anCells ? v.anCells[u] : null) &&
                      o.push(w);
                  } else o.push(w);
                }
              }
  ...
  o("destroy()", function (a) {
    ...
    return this.iterator("table", function (b) {
      ...
      a || new s(b).columns().visible(true);
  ...
  h.extend(l.ext.type.detect, [
    ...
    function (a) {
      return I(a) || (typeof a === "string" && a.indexOf("<") !== -1)
        ? "html"
        : null;
    },
  ]);
